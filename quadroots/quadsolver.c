...
/*getInput() - Grabs input from user and passes that to initInput()
*	which will then put them into the passed struct.
*/
int getInput(Coef *coef)
{
	double aIn,bIn,cIn;
...
/*init Input - Initializes the variables needed for the mpfr library from input*/
int initInput(Coef *coef, double aIn, double bIn, double cIn)
{
